 ...
 *         export const check: FileCheckDeclarationInput = { type: FileCheckType.EXISTS };
 *     ```
 *
 ...
 *
 *         // or if you'd like to be more explicit
 *         export const check: FileCheckDeclarationInput = { type: FileCheckType.EQUALS, optional: true };
 *     ```
 *
 ...
 *
 *         // or if you'd like to be more explicit
 *         export const check: FileCheckDeclarationInput = { type: FileCheckType.CONTAINS };
 *     ```
 *
 ...
 *     ```
 */
export interface FileCheckDeclarationInput {
  /**
