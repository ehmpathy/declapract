...
import { FileCheckPurpose, FileEvaluationResult } from '@src/domain.objects';
...
import { evaluteProjectAgainstPracticeDeclaration } from '@src/domain.operations/usage/evaluate/evaluateProjectAgainstPracticeDeclaration';
