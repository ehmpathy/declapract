...
import { CheckFileDeclaration, CheckFileEvaluation, CheckFileEvaluationResult } from '../../domain';
...
export const checkProjectAgainstCheckFileDeclaration = async ({
  practiceRef,
  ...
  return await Promise.all(
    pathsToCheck.map(async (relativePath) => {
      ...
      try {
        ...
        return new CheckFileEvaluation({
          practiceRef,
          check,
          path: relativePath,
